...
try{
const response=await fetch(`http://localhost:8080/api/cart/applyDiscount/${cartId}?type=${discountType}&value=${discountValue}`,{
method:'POST',
headers:{
...
<button onClick={()=>navigate('/products')} className="w-full border-2 border-amber-500 text-amber-600 py-4 rounded-xl text-lg font-semibold hover:bg-amber-50 transition-all">
Continue Shopping
</button>
</div>
